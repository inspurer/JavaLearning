...
/**
 * 
 * @author csu_xiaotao 上午11:56:16 2018年4月16日
 */
public class App4_1 implements ActionListener {
		...
		public void itemStateChanged(ItemEvent e) {
			...
			/*	System.out.println("yes"+JOptionPane.YES_OPTION);
				...
				if (n == JOptionPane.YES_OPTION)
					...
					/**
					 * 为什么要点两下“否”才能关掉对话框
					 * 在else if里面再次触发了itemStateChanged方法！！！
					 * 这又是为什么
					 * 2018/4/17 12:31
					 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(jb_login)) {
			...
			if (account.length()==0 ||password.length() == 0)
				...
				JOptionPane.showConfirmDialog(jf, "Keep it in mind!\n账户: "+account+"\n密码:"+password, "提示", JOptionPane.OK_CANCEL_OPTION);
		}
	}
}
